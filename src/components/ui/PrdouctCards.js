  ...
  return (
    <>
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-0 lg:gap-6 lg:max-w-7xl mx-auto p-7">
              ...
              <div className="card w-full rounded card-compact bg-base-100 shadow-xl">
                ...
                <div className="card-body">
                  ...
                  <div className="card-actions justify-between">
                    ...
                    <button className="font-medium btn-sm px-1.5 py-1 bg-[#212529] text-white  border-none rounded">
                      Add to Cart
                    </button>
                  </div>
                </div>
        ...
        <div className=" col-span-2 mt-0 lg:mt-[133px]">
          <Cart />
        </div>
      </div>
    </>
